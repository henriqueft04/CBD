...
public class MainA {
    ...
    private static final String DATABASE_NAME = "sistema_atendimentoA"; // Replace with your database name

    public static void main(String[] args) {
        // Define the maximum number of products per user and the timespan in seconds
        int limit = 30; // Maximum number of products per user
        long timeslot = 60 * 60; // Timespan in seconds (e.g., 60 minutes)

        // Create an instance of SistemaAtendimento
        SistemaAtendimentoA sistema = new SistemaAtendimentoA(limit, timeslot);
            ...
            do {
                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        sistema.buyProduct(userName, productName, usersCollection, productsCollection);
                        break;
                    case 6:
                        System.out.print("Enter user name: ");
